...
# @api_view(['GET', 'POST'])
# def product_list(request): #Function-based view
...
# class ProductList(ListCreateAPIView): #Generic class-based view
...
# class ProductDetail(RetrieveUpdateDestroyAPIView): #Generic class-based view
#     queryset = Product.objects.all()
#     serializer_class = ProductSerializer
...
#             return Response(
#                {'error': 'Product cannnot be deleted because it is associated with an order item'}, 
#                status=status.HTTP_405_METHOD_NOT_ALLOWED
#             )
#             product.delete()
#         return Response(status=status.HTTP_204_NO_CONTENT)

class ProductViewSet(ModelViewSet): #ViewSet
...
# def product_detail(request, id): #Function-based view
...
# class ProductDetail(APIView): #Class-based view
...
# class CollectionList(ListCreateAPIView): #Generic class-based view
...
# class CollectionDetail(RetrieveUpdateDestroyAPIView): #Generic class-based view
#     queryset = Collection.objects.annotate(products_count=Count('products')).all()
#     serializer_class = CollectionSerializer
...
class CollectionViewSet(ModelViewSet): #ViewSet
...
class OrderViewSet(ModelViewSet):
    ...
    def get_queryset(self):
        ...
        customer = Customer.objects.only('id').get(user_id=user)
